 ...
 * 
 */
sap.ui.vbm.Adapter.prototype.load = function(data) { return null; };
 ...
 * <li>Associations
 * <ul>
 * <li>{@link #getViewport viewport} : (sap.ui.core.ID | sap.ui.vbm.Viewport)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * 
 */
sap.ui.vbm.Adapter3D = function(sId,mSettings) {};
/**
 ...
 * @param {sap.ui.base.EventProvider} oControlEvent.getSource
 * @param {object} oControlEvent.getParameters
 * @param {string} oControlEvent.getParameters.data A string in the VBI JSON format.
 * @public
 * 
 */
sap.ui.vbm.Adapter3D.prototype.submit = function(oControlEvent) {  };

/**
 * Attaches event handler <code>fnFunction</code> to the {@link #event:submit submit} event of this <code>sap.ui.vbm.Adapter3D</code>.
 * 
 * When called, the context of the event handler (its <code>this</code>) will be bound to <code>oListener</code> if specified, 
 * otherwise it will be bound to this <code>sap.ui.vbm.Adapter3D</code> itself.
 * 
 * This event is fired when interactions in the viewport happen.
 * 
 * @param {object}
 ...
 *            fnFunction The function to be called when the event occurs
 * @param {object}
 *            [oListener] Context object to call the event handler with. Defaults to this <code>sap.ui.vbm.Adapter3D</code> itself
 * 
 * @returns {sap.ui.vbm.Adapter3D} Reference to <code>this</code> in order to allow method chaining
 * @public
 * 
 */
sap.ui.vbm.Adapter3D.prototype.attachSubmit = function(oData,fnFunction,oListener) { return new sap.ui.vbm.Adapter3D(); };

/**
 * Detaches event handler <code>fnFunction</code> from the {@link #event:submit submit} event of this <code>sap.ui.vbm.Adapter3D</code>.
 * 
 * The passed function and listener object must match the ones used for event registration.
 * 
 * @param {function}
 ...
 * 
 */
sap.ui.vbm.Adapter3D.prototype.detachSubmit = function(fnFunction,oListener) { return new sap.ui.vbm.Adapter3D(); };

/**
 * Creates a new subclass of class sap.ui.vbm.Adapter3D with name <code>sClassName</code>
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.core.Element.extend}.
 * 
 ...
 * 
 */
sap.ui.vbm.Adapter3D.extend = function(sClassName,oClassInfo,FNMetaImpl) { return function() {}; };

/**
 * Fires event {@link #event:submit submit} to attached listeners.
 * 
 * @param {object} [mParameters] Parameters to pass along with the event
 * @param {string} [mParameters.data] A string in the VBI JSON format.
 * 
 * @returns {sap.ui.vbm.Adapter3D} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 */
sap.ui.vbm.Adapter3D.prototype.fireSubmit = function(mParameters) { return new sap.ui.vbm.Adapter3D(); };
 ...
 * 
 */
sap.ui.vbm.Adapter3D.getMetadata = function() { return new sap.ui.base.Metadata(); };

/**
 * ID of the element which is the current target of the association {@link #getViewport viewport}, or <code>null</code>.
 * 
 * @returns {sap.ui.core.ID}
 * 
 * @public
 * 
 */
sap.ui.vbm.Adapter3D.prototype.getViewport = function() { return new sap.ui.core.ID(); };
 ...
 * 
 */
sap.ui.vbm.Adapter3D.prototype.load = function(data) { return null; };

/**
 * Sets the associated {@link #getViewport viewport}.
 * @param {sap.ui.core.ID | sap.ui.vbm.Viewport} oViewport ID of an element which becomes the new target of this viewport association; alternatively, an element instance may be given
 * @returns {sap.ui.vbm.Adapter3D} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ui.vbm.Adapter3D.prototype.setViewport = function(oViewport) { return new sap.ui.vbm.Adapter3D(); };
 ...
 * 
 */
sap.ui.vbm.GeoMap.prototype.zoomToAreasById = function(ui5AreaIds,correlationFactor) { return new sap.ui.vbm.GeoMap(); };
 ...
 * <li>{@link #getEnableOverlappingTest enableOverlappingTest} : boolean (default: true)</li>
 * </ul>
 * </li>
 * <li>Events
 * <ul>
 ...
 * 
 * Default value is <code>true</code>.
 * @returns {boolean} Value of property <code>enableOverlappingTest</code>
 * 
 * @public
 * 
 */
sap.ui.vbm.VBI.prototype.getEnableOverlappingTest = function() { return false; };
 ...
 * 
 * Default value is <code>true</code>.
 * @param {boolean} bEnableOverlappingTest New value for property <code>enableOverlappingTest</code>
 * @returns {sap.ui.vbm.VBI} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ui.vbm.VBI.prototype.setEnableOverlappingTest = function(bEnableOverlappingTest) { return new sap.ui.vbm.VBI(); };
 ...
 * 
 */
sap.ui.vbm.Viewport = function() {};
/**
 * Creates a new subclass of class sap.ui.vbm.Viewport with name <code>sClassName</code>
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.core.Control.extend}.
 * 
 ...
 * 
 */
sap.ui.vbm.Viewport.extend = function(sClassName,oClassInfo,FNMetaImpl) { return function() {}; };
 ...
 * 
 */
sap.ui.vbm.Viewport.prototype.getHeight = function() { return new sap.ui.core.CSSSize(); };
 ...
 * 
 */
sap.ui.vbm.Viewport.getMetadata = function() { return new sap.ui.base.Metadata(); };
 ...
 * 
 */
sap.ui.vbm.Viewport.prototype.getWidth = function() { return new sap.ui.core.CSSSize(); };
 ...
 * Default value is <code>100%</code>.
 * @param {sap.ui.core.CSSSize} sHeight New value for property <code>height</code>
 * @returns {sap.ui.vbm.Viewport} Reference to <code>this</code> in order to allow method chaining
 * 
 * @public
 * 
 */
sap.ui.vbm.Viewport.prototype.setHeight = function(sHeight) { return new sap.ui.vbm.Viewport(); };
 ...
 * 
 */
sap.ui.vbm.Viewport.prototype.setWidth = function(sWidth) { return new sap.ui.vbm.Viewport(); };
