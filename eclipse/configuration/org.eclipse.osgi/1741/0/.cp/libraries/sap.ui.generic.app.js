 ...
 * If no properties or entities are passed the unspecified side effect is executed if one is
 * annotated. This unspecified side effect uses the annotated targets of the unspecified
 * side effect.
 * In case of bForceGlobalRefresh is set to <code>true</code> a model refresh is triggered in
 * all cases.
 * 
 ...
 * 
 */
sap.ui.generic.app.ApplicationController.prototype.executeSideEffects = function(oContext,aSourceProperties,aSourceEntities,bForceGlobalRefresh) { return null; };

/**
 * Creates a new subclass of class sap.ui.generic.app.ApplicationController with name <code>sClassName</code>
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.generic.app.transaction.BaseController.extend}.
 * 
 ...
 * 
 */
sap.ui.generic.app.ApplicationController.prototype.invokeActions = function(sFunctionName,aContexts,mParameters) { return null; };
...
/**
 * 
 * @class Creates a new NavigationHandler class by providing the required environment. <b>Note:</b> This class requires that the UShell
 *        Navigation Service API CrossApplicationNavigation is available and initialized.
 * @extends sap.ui.base.Object
 * @constructor
 * @public
 ...
 * 
 */
sap.ui.generic.app.transaction.DraftController.prototype.createNewDraftEntity = function(sEntitySet,sPath,vPredefinedValues) { return null; };
