 ...
 * 
 */
sap.ui.fl.variants.VariantModel = function(oData,oFlexController,oComponent,bObserve) {};
/**
 * Creates a new subclass of class sap.ui.fl.variants.VariantModel with name <code>sClassName</code>
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 ...
 * 
 */
sap.ui.fl.variants.VariantModel.extend = function(sClassName,oClassInfo,FNMetaImpl) { return function() {}; };
 ...
 * 
 */
sap.ui.fl.variants.VariantModel.prototype.getCurrentVariantReference = function(sVariantManagementReference) { return ""; };
 ...
 * 
 */
sap.ui.fl.variants.VariantModel.getMetadata = function() { return new sap.ui.base.Metadata(); };
