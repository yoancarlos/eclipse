 ...
 * 
 */
sap.ui.unified.Calendar.prototype.getStartDate = function() { return null; };
 ...
 * 
 */
sap.ui.unified.Calendar.prototype.setMaxDate = function(oDate) { return new sap.ui.unified.Calendar(); };
 ...
 * 
 */
sap.ui.unified.Calendar.prototype.setMinDate = function(oDate) { return new sap.ui.unified.Calendar(); };
 ...
 * 
 */
sap.ui.unified.calendar.DatesRow.prototype.setFirstDayOfWeek = function(iFirstDayOfWeek) { return new sap.ui.unified.calendar.DatesRow(); };
 ...
 * 
 */
sap.ui.unified.CalendarAppointment.prototype.setColor = function(sColor) { return new sap.ui.unified.CalendarAppointment(); };
 ...
 * 
 */
sap.ui.unified.CalendarDateInterval.prototype._getDaysLarge = function() { return 0; };
 ...
 * 
 */
sap.ui.unified.CalendarDateInterval.prototype.setFirstDayOfWeek = function(iFirstDayOfWeek) { return new sap.ui.unified.CalendarDateInterval(); };
 ...
 * 
 */
sap.ui.unified.CalendarDateInterval.prototype.setMonths = function(iMonths) { return new sap.ui.unified.CalendarDateInterval(); };
 ...
 * @returns {string[]} Value of property <code>standardItems</code>
 * @since 1.54
 * 
 * @public
 * 
 */
sap.ui.unified.CalendarLegend.prototype.getStandardItems = function() { return new Array(); };
 ...
 * 
 * Default value is <code>Today,Selected,WorkingDay,NonWorkingDay</code>.
 * @param {string[]} sStandardItems New value for property <code>standardItems</code>
 * @returns {sap.ui.unified.CalendarLegend} Reference to <code>this</code> in order to allow method chaining
 * @since 1.54
 * 
 * @public
 * 
 */
sap.ui.unified.CalendarLegend.prototype.setStandardItems = function(sStandardItems) { return new sap.ui.unified.CalendarLegend(); };
 ...
 * @param {string} oControlEvent.getParameters.domRefId Gives the ID of the DOM element of the clicked appointment
 * @public
 * 
 */
 ...
 * So more than the current appointment could be selected.
 * @param {string} [mParameters.domRefId] Gives the ID of the DOM element of the clicked appointment
 * 
 * @returns {sap.ui.unified.CalendarRow} Reference to <code>this</code> in order to allow method chaining
 * @protected
 * 
 ...
 * 
 */
sap.ui.unified.Currency.prototype.getAccessibilityInfo = function() { return null; };
 ...
 * 
 * @returns {string} Value of property <code>stringValue</code>
 * @since 1.54
 * 
 * @public
 * 
 */
sap.ui.unified.Currency.prototype.getStringValue = function() { return ""; };
 ...
 * When called with a value of <code>null</code> or <code>undefined</code>, the default value of the property will be restored.
 * 
 * @param {string} sStringValue New value for property <code>stringValue</code>
 * @returns {sap.ui.unified.Currency} Reference to <code>this</code> in order to allow method chaining
 * @since 1.54
 * 
 * @public
 * 
 */
sap.ui.unified.Currency.prototype.setStringValue = function(sStringValue) { return new sap.ui.unified.Currency(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.abort = function(sHeaderParameterName,sHeaderParameterValue) {  };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.clear = function() { return new sap.ui.unified.FileUploader(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.destroyXhrSettings = function() { return new sap.ui.unified.FileUploader(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.getProcessedBlobsFromArray = function(aBlobs) { return null; };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.getValueStateText = function() { return ""; };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.getXhrSettings = function() { return new sap.ui.unified.FileUploaderXHRSettings(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.setValueStateText = function(sValueStateText) { return new sap.ui.unified.FileUploader(); };
 ...
 * @param {sap.ui.unified.FileUploaderXHRSettings} oXhrSettings The xhrSettings to set
 * @returns {sap.ui.unified.FileUploader} Reference to <code>this</code> in order to allow method chaining
 * @since 1.52
 * 
 * @public
 * 
 */
sap.ui.unified.FileUploader.prototype.setXhrSettings = function(oXhrSettings) { return new sap.ui.unified.FileUploader(); };
 ...
 * 
 */
sap.ui.unified.FileUploader.prototype.upload = function(bPreProcessFiles) { return null; };
 ...
 * 
 */
sap.ui.unified.FileUploaderXHRSettings = function(sId,mSettings) {};
/**
 * Creates a new subclass of class sap.ui.unified.FileUploaderXHRSettings with name <code>sClassName</code>
 * and enriches it with the information contained in <code>oClassInfo</code>.
 * 
 * <code>oClassInfo</code> might contain the same kind of information as described in {@link sap.ui.core.Element.extend}.
 * 
 ...
 * 
 */
sap.ui.unified.FileUploaderXHRSettings.extend = function(sClassName,oClassInfo,FNMetaImpl) { return function() {}; };
 ...
 * 
 */
sap.ui.unified.FileUploaderXHRSettings.getMetadata = function() { return new sap.ui.base.Metadata(); };
 ...
 * 
 * Default value is <code>false</code>.
 * @returns {boolean} Value of property <code>withCredentials</code>
 * @since 1.52
 * 
 * @public
 * 
 */
sap.ui.unified.FileUploaderXHRSettings.prototype.getWithCredentials = function() { return false; };
 ...
 * 
 * Default value is <code>false</code>.
 * @param {boolean} bWithCredentials New value for property <code>withCredentials</code>
 * @returns {sap.ui.unified.FileUploaderXHRSettings} Reference to <code>this</code> in order to allow method chaining
 * @since 1.52
 * 
 * @public
 * 
 */
sap.ui.unified.FileUploaderXHRSettings.prototype.setWithCredentials = function(bWithCredentials) { return new sap.ui.unified.FileUploaderXHRSettings(); };
 ...
 * 
 */
sap.ui.unified.IProcessableBlobs.getProcessedBlobsFromArray = function(aBlobs) { return null; };
 ...
 * 
 */
sap.ui.unified.Menu.prototype.open = function(bWithKeyboard,oOpenerRef,my,at,of,offset,collision) { return null; };
 ...
 * 
 */
sap.ui.unified.MenuTextFieldItem.prototype.setSubmenu = function(oMenu) { return new sap.ui.unified.MenuTextFieldItem(); };
...
// dummy function to make Eclipse aware of namespace
sap.ui.unified.StandardCalendarLegendItem.toString = function() { return ""; };
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type11 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type12 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type13 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type14 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type15 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type16 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type17 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type18 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type19 = "";
 ...
 * 
 */
sap.ui.unified.CalendarDayType.Type20 = "";
